...
#
#
# async def new_appointment(update: Update, context):
...
#     return BRANCH
#
# async def view_appointments(update: Update, context):
...
async def new_appointment(update: Update, context: CallbackContext):
    keyboard = [
        [InlineKeyboardButton("Branch 1", callback_data='branch_1')],
        [InlineKeyboardButton("Branch 2", callback_data='branch_2')],
        [InlineKeyboardButton("Branch 3", callback_data='branch_3')]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
async def personal_info(update: Update, context: CallbackContext):
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text('Выберите врача:', reply_markup=reply_markup)
    return DOCTOR
...
async def button_handler(update: Update, context: CallbackContext):
    ...
    if data == 'new_appointment':
        await new_appointment(update, context)
    elif data == 'view':
