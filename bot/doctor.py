...
async def phone(update: Update, context: CallbackContext, from_back=False):
    ...
    keyboard = [
        [InlineKeyboardButton("Терапевт", callback_data='dentist'),
         InlineKeyboardButton("Хирург", callback_data='surgeon')],
        [InlineKeyboardButton("Имплантолог", callback_data='implantologist'),
         InlineKeyboardButton("Парадонтолог", callback_data='periodontist')],
        [InlineKeyboardButton("Профчистка", callback_data='cleaning')],
        [InlineKeyboardButton("Вернуться назад", callback_data='return_phone')]
    ]
...
async def procedure(update: Update, context: CallbackContext, from_back=False):
    ...
    keyboard = [
        [InlineKeyboardButton("Доктор Игорь", callback_data='select_doctor_igor'),
         InlineKeyboardButton("Доктор Яков", callback_data='select_doctor_jacob')],
